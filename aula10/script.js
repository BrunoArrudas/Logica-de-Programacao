...
class Arqueiro extends Personagem {
    ...
    recarregarFlecha(quantidades){
        this.totalDeFlechas += quantidades;
...
console.log(persoArqueiro.atacar(persoArqueiro2));
console.log(persoArqueiro.atacar(persoArqueiro2));
console.log(`Total de flechas do ${persoArqueiro.nome} agora e ${persoArqueiro.recarregarFlecha(5)}`);

//console.log(persoArqueiro.atacar(persoArqueiro2)); Repete ataque
//console.log(persoArqueiro.atacar(persoArqueiro2)); Repete ataque
